...
public class JavaScriptParserBaseListener implements JavaScriptParserListener {
     ...
     */
    @Override
    public void enterForVarStatement(JavaScriptParser.ForVarStatementContext ctx) {
     ...
     */
    @Override
    public void exitForVarStatement(JavaScriptParser.ForVarStatementContext ctx) {
     ...
     */
    @Override
    public void exitForVarInStatement(JavaScriptParser.ForVarInStatementContext ctx) {
     ...
     */
    @Override
    public void exitGeneratorMethod(JavaScriptParser.GeneratorMethodContext ctx) {
     ...
     */
    @Override
    public void exitLastElement(JavaScriptParser.LastElementContext ctx) {
     ...
     */
    @Override
    public void exitLastArgument(JavaScriptParser.LastArgumentContext ctx) {
